...
import { promotions, banks } from "@/lib/mock-data"
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-background-secondary">
        <div className="container-custom py-8 md:py-12">
          {/* Page Header */}
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Спецпредложения от банков</h1>
            <p className="text-foreground-secondary">Эксклюзивные условия и акции для пользователей нашего сервиса</p>
          </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select value={selectedType} onValueChange={setSelectedType}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="free_service">Бесплатное обслуживание</SelectItem>
          ...
          {filteredPromotions.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-lg text-foreground-secondary mb-2">
                {hasActiveFilters ? "Акций с такими условиями не найдено" : "Пока нет активных спецпредложений"}
              </p>
              <p className="text-sm text-foreground-muted mb-4">
                {hasActiveFilters ? "Попробуйте изменить фильтры" : "Следите за обновлениями"}
              </p>
              {hasActiveFilters && <Button onClick={clearFilters}>Сбросить фильтры</Button>}
            </div>
          )}
        </div>
      </main>
