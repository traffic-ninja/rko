...
import { SelectionSkeleton } from "@/components/ui/selection-skeleton";

export const metadata: Metadata = {
  title: "Подбор РКО — Умный поиск тарифов для бизнеса",
  description: "Подберите оптимальное расчётно-кассовое обслуживание для вашего бизнеса за 2 минуты. Умный алгоритм учтёт оборот, количество операций и регион.",
  keywords: "подбор РКО, найти тариф РКО, сравнение тарифов, калькулятор РКО, выбрать банк для ИП, выбрать банк для ООО",
  openGraph: {
