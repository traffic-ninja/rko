...
export default function BanksPageClient({ initialBanks }: { initialBanks: Bank[] }) {
	...
	const filteredBanks = useMemo(() => {
		let result = [...initialBanks]; // Use initialBanks instead of banks
		...
		return result;
	}, [initialBanks, hasFreeTariff, hasOnlineOpening, sortBy]); // Add initialBanks to dependencies
