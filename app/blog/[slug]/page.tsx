...
import { ChevronRight, Clock, Calendar, Share2, ArrowRight, User } from "lucide-react"
        ...
        <article className="container-custom py-8 md:py-12">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <Card className="bg-primary/5 border-primary/20 mb-8">
                <CardContent className="py-6">
                  <h3 className="text-xl font-semibold text-foreground mb-3">Хотите подобрать РКО под ваш бизнес?</h3>
                  <p className="text-foreground-secondary mb-4">
                    Воспользуйтесь нашим калькулятором и получите персональные рекомендации за пару минут
                  </p>
                  <Button asChild>
                    <Link href="/selection">
                      Подобрать тариф
                ...
                <CardContent className="py-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground-secondary">Автор статьи</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              {/* Share */}
              <div className="flex items-center gap-4">
                <span className="text-sm text-foreground-secondary">Поделиться:</span>
            ...
            <aside className="space-y-6">
              <Card>
                <CardContent className="py-6">
                  <h3 className="font-semibold text-foreground mb-4">Быстрый подбор РКО</h3>
              ...
              <Card>
                <CardContent className="py-6">
                  <h3 className="font-semibold text-foreground mb-4">Популярные банки</h3>
          ...
          {relatedPosts.length > 0 && (
            <section className="mt-12">
              <h2 className="text-2xl font-bold text-foreground mb-6">Похожие статьи</h2>
