...
export function SelectionClientPage({ initialTariffs, initialRegions }: SelectionClientPageProps) {
							...
							{topResults.length > 0 ? (
								<>
									<div className="grid md:grid-cols-3 gap-6">
										{topResults.map((tariff: Tables<'tariffs'>) => (
											<TariffCard
												key={tariff.id}
												tariff={tariff}
												showBankInfo
									...
									{showMoreResults && additionalResults.length > 0 && (
										<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
											{additionalResults.map((tariff: Tables<'tariffs'>) => (
												<TariffCard
													key={tariff.id}
													tariff={tariff}
													showBankInfo
