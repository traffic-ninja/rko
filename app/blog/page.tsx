    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-background-secondary">
        <div className="container-custom py-8 md:py-12">
          {/* Page Header */}
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Блог о РКО</h1>
            <p className="text-foreground-secondary">Полезные материалы о расчётно-кассовом обслуживании для бизнеса</p>
          </div>
          ...
          {currentPosts.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-lg text-foreground-secondary">Статей пока нет</p>
